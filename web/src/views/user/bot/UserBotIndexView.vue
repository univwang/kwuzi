...
export default {
    ...
    setup() {
        ...
        const refresh_bots = () => {
            $.ajax({
                // url: "https://app2981.acapp.acwing.com.cn/api/user/bot/getlist/",
                url: Global.apiUrl + "/api/user/bot/getlist/",
        ...
        const add_bot = () => {
            ...
            $.ajax({
                // url: "https://app2981.acapp.acwing.com.cn/api/user/bot/add/",
                url: Global.apiUrl + "/api/user/bot/add/",
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                // url: "https://app2981.acapp.acwing.com.cn/api/user/bot/update/",
                url: Global.apiUrl + "/api/user/bot/update/",
        ...
        const remove_bot = (bot) => {
          console.log(bot)
            $.ajax({
                // url: "https://app2981.acapp.acwing.com.cn/api/user/bot/remove/",
                url: Global.apiUrl + "/api/user/bot/remove/",
